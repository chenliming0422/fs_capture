...
bool pointGreyCapture::initCamera(unsigned int imageWidth, unsigned int imageHeight, float frameRate, float exposureTime_ms, bool isHardwareTrigger)
{
	...
	// setup gain to be always 1.0 to minimize noise impact
	setGainValue(0.0);
